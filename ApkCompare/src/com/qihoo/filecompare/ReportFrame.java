...
public class ReportFrame {
	...
	public static String CreatCaseReport(String olderApkName,String newerApkName, double oldApkSize, double newApkSize) throws IOException{
		...
		String caseContent = "<html><head>"+
        		...
        		".child_title_text { font-family: verdana; font-size: 15px;  font-weight: bold;}" +
        		...
        		".border_title { border: 0px solid #045AFD}" +
        		...
        		"<td class=border_left ><p class=bold_text align='center'>所在目录</p></td>" +
	...
	public static void putsStep(String stepDesc){
		String stepContent = "<tr class=border_null></tr><tr>" +
				"<td class=border_title colspan='5' ><p class=child_title_text align='left'><font color='#FF0000'><b>"+ stepDesc +"</b></p></td>" +
				"</tr>";
    	try{
	...
	public static void putsChildStep(String stepDesc){
		String stepContent = "<tr>" +
				"<td class=border_left colspan='7' ><p class=normal_text align='left'><font color='#FF0000'><b>"+ stepDesc +"</b></p></td>" +
				"</tr>";
    	try{
	        FileWriter addWrite = new FileWriter(repotHtml, true);
	        addWrite.append(stepContent);//写入Html
	...
	public static void writeReport(String tag, String folder, String changedFile, float oldSize, float newSize){
		...
		//文件增量
			...
			if(tag.equals("增加文件")){
				 ps = "<tr>" +
		    			...
		    			"<td class=border_left ><p class=normal_text align='center'>"+ folder +"</p></td>" +
